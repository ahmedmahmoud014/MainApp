...
class MainTableViewScreen: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mainTB.register(UINib(nibName: "MainTableViewCell", bundle: nil), forCellReuseIdentifier: "MainTableViewCell")
        ...
        mainTB.rowHeight   =  200
        mainTB.sectionFooterHeight = 20
        ...
        dataSource.canEditRowAtIndexPath = { dataSource, indexPath  in
           ...
           allData.asObservable().bind(to: mainTB.rx.items(dataSource: dataSource)).disposed(by: disposeBag)
        
        // for delete rows
        mainTB.rx.itemDeleted
            .map { indexPath in
